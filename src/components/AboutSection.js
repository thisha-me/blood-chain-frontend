        ...
        <div className="min-h-screen flex items-center justify-center ">
            ...
            <div className=" flex-col items-center justify-center">
                <div className="mx-0 px-6 py-0 flex flex-wrap items-center justify-center ">
                    ...
                    <div>
                        <p className="text-[#DC143C] font-medium p-2 text-2xl">Find Blood</p>
                    </div>
                    </div>
                    <div
                    style={{ maxWidth: '400px', height: '200px', width: '200px' }}
                    ...
                    <div>
                        <p className="text-[#DC143C] font-medium p-2 text-2xl">Get Notified</p>
                    </div>
                    </div>
                </div>
                <div className="mx-0 px-6 py-0 flex flex-wrap items-center justify-center">
                    ...
                    <div>
                        <p className="text-[#DC143C] font-medium p-2 text-2xl">Free Forever</p>
                    </div>
                    </div>
                    <div
                    style={{ maxWidth: '400px', height: '200px', width: '200px' }}
                    ...
                    <div>
                        <p className="text-[#DC143C] font-medium p-2 text-2xl">Save a Life</p>
                    </div>
                    </div>
                </div>
        </div>
                <div className="">
                    <div className="max-w-lg w-full rounded overflow-hidden mx-2 flex flex-col justify-center items-center">
                        ...
                        <p style={{fontSize: '18px'}} className="text-[#000000] font-normal p-2 text-justify">Transforming donation landscapes. Decentralized platform revolutionizes blood & organ access. Secure data, empowered patients, transparent impact. <span className=" font-bold">Join the life-saving chain.</span><br /></p>
                            <button className= {`bg-[#8C0909] hover:bg-red-700 text-white font-bold py-2 px-4 rounded-xl ${isMobile_1 ? "mx-auto" : " "}`}>Read More</button>
                            <br/><br/>
