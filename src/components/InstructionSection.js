    ...
    <div className="bg-[#F0F0F0] min-h-screen flex flex-col items-center justify-center">
      ...
      <div className= {`flex ${isMobile ? "flex-col" : "flex"} items-center justify-between`}>
        ...
        <div className=" max-w-lg  w-full">
          <p style={{ fontSize: '1.4rem' }} className="text-[#000000] font-normal p-2  text-justify">Once a match is made, our platform securely connects you directly with the donor or recipient. Communicate details and arrange the blood transfer without intermediaries.</p>
          <ul className="list-disc pl-6 leading-loose">
            <li className="flex items-center">
              <img src={icon} alt="Register Icon" />
              <p style={{ fontSize: '1.4rem' }} className="mr-2 text-[#000000] text-2xl font-normal p-2">Register</p>
            </li>
            <li className="flex items-center">
              <img src={icon} alt="Profile Icon" />
              <p style={{ fontSize: '1.4rem' }} className="mr-2 text-[#000000] text-2xl font-normal p-2">Fill your Profile</p>
            </li>
            <li className="flex items-center">
              <img src={icon} alt="Request Icon" />
              <p style={{ fontSize: '1.4rem' }} className="mr-2 text-[#000000] text-2xl font-normal p-2">Request Blood</p>
            </li>
            <li className="flex items-center">
            ...
            <li className="flex items-center">
              ...
              <p style={{ fontSize: '1.4rem' }} className="mr-2 text-[#000000] text-2xl font-normal p-2">View pending Requests</p>
            </li>
          </ul>
          <br/>
